...
function ShowProfileBanners()
	local t = {
		Name = "ShowProfileBanners",
		LayoutType = "ShowAllInRow",
		SelectType = "SelectOne",
		OneChoiceForAllPlayers = true,
		ExportOnChange = false,
		...
		Choices = {THEME:GetString("OptionNames", "Off"), THEME:GetString("OptionNames", "On")},
		LoadSelections = function(self, list, pn)
			local pref = themeConfig:get_data().global.ShowProfileBanners
			if pref then
				list[2] = true
			else
				list[1] = true
		...
		SaveSelections = function(self, list, pn)
			...
			themeConfig:get_data().global.ShowProfileBanners = value
			themeConfig:set_dirty()
			themeConfig:save()
		end
	}
...
function WifeLeftRightHands()
	local t = {
		Name = "WifeLeftRightHands",
		LayoutType = "ShowAllInRow",
		SelectType = "SelectOne",
		OneChoiceForAllPlayers = true,
		ExportOnChange = false,
		...
		Choices = {THEME:GetString("OptionNames", "Off"), THEME:GetString("OptionNames", "On")},
		LoadSelections = function(self, list, pn)
			local pref = themeConfig:get_data().global.WifeLeftRightHands
			if pref then
				list[2] = true
			else
				list[1] = true
		...
		SaveSelections = function(self, list, pn)
			...
			themeConfig:get_data().global.WifeLeftRightHands = value
			themeConfig:set_dirty()
			themeConfig:save()
		end
	}
...
function ManipFactor()
	local t = {
		...
		Choices = {THEME:GetString("OptionNames", "Off"), THEME:GetString("OptionNames", "On")},
		LoadSelections = function(self, list, pn)
			local pref = themeConfig:get_data().global.ManipFactor
			if pref then
				list[2] = true
			else
				list[1] = true
		...
		SaveSelections = function(self, list, pn)
			...
			themeConfig:get_data().global.ManipFactor = value
			themeConfig:set_dirty()
			themeConfig:save()
		end
	}
...
function ChordDensityTimeStamp()
	local t = {
		Name = "ChordDensityTimeStamp",
		LayoutType = "ShowAllInRow",
		SelectType = "SelectOne",
		OneChoiceForAllPlayers = true,
		ExportOnChange = false,
		...
		Choices = {THEME:GetString("OptionNames", "Off"), THEME:GetString("OptionNames", "On")},
		LoadSelections = function(self, list, pn)
			local pref = themeConfig:get_data().global.ChordDensityTimeStamp
			if pref then
				list[2] = true
			else
				list[1] = true
		...
		SaveSelections = function(self, list, pn)
			...
			themeConfig:get_data().global.ChordDensityTimeStamp = value
			themeConfig:set_dirty()
			themeConfig:save()
		end
	}
