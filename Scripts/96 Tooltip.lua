...
function TOOLTIP.SetTextMSD(self, SkillsetTrans, SkillsetNum)
    if self == nil or self.Actor == nil then return end
    self.Actor:GetChild("Text"):settextf("%s: %05.2f", SkillsetTrans, SkillsetNum)
    self.Actor:playcommand("Resize")
end
...
function TOOLTIP.SwitchSide(self, trueorna) --false being left, true being right
    sideswapped = trueorna
end
